...
function TakeSelectingElement (Naming) {
    ...
    nameCategory.forEach((item) => {
        ...
        item.addEventListener('change', (e) =>{
            ...
            RegularExpression(e.target.value);
        });   
...
function WorkingFunctionTranslation(Naming){

        TakeSelectingElement (Naming);
        ...
        SelectForm.forEach((item) => {
            ...
            let input = Parent.querySelector(`.${generateConfig(config, Naming)}`);
...
WorkingFunctionTranslation("name");
WorkingFunctionTranslation("text");
