...
@section('content')
				<!-- row -->
				<div class="row">
					<form class="col-lg-12 col-md-12 form_products" action={{ route('products.store') }} method="POST" enctype="multipart/form-data">
						@csrf
						{{ method_field('POST') }}
						<div class="card">
							<div class="card-body">
								<div class="mb-4">
                                    <div class="form-group name_products">
                                        ...
                                        <input class="form-control text_products" type="text" placeholder="{{ __('products.Name-Of-Product') }}" data-name="name_pro"  name="name_pro_en">
                                    </div>
								</div>
								<div class="mb-4">
                                    <div class="form-group price_products">
                                        <label class="label_products mt-3"> price </label>
                                        <input class="form-control price_products" type="number" placeholder="{{ __('products.Name-Of-Product') }}" data-name="number_pro"  name="number_pro">
                                    </div>
								</div>
								<div class="mb-4">
                                    <div class="form-group description_products">
                                        <label class="label_products mt-3"> Description Product  </label>
										<textarea class="form-control desc_products" placeholder="{{ __('products.Name-Of-Product') }}" rows="3" data-name="des_pro" name="des_pro_en"></textarea>
                                    </div>
								</div>
								<!-- Build your select: -->
								<div class="mb-4">
